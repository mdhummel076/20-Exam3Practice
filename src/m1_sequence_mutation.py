...
def run_test_zero_changer():
    ...
    # Test 1:
    test1 = ([0,0,0],[4,5,6],[0,0,0])
    expected1 = ([1, 2, 3], [4, 5, 6], [4, 5, 6])
    zero_changer(test1)
    print()
    print('Test 1:')
    print('  Expected:', expected1)
    ...
    # Test 1:
    test1 = ([0,1,2,3],[0,2,3,4],[0,3,4,5],[0,4,5,6])
    expected1 = ([1,1,2,3],[2,2,3,4],[3,3,4,5],[4,4,5,6])
    zero_changer(test1)
    print()
    print('Test 1:')
    print('  Expected:', expected1)
